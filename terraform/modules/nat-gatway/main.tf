...
resource "aws_route_table_association" "private_app_subnet_az1_rt_az1_association" {
  ...
  route_table_id = var.private_route_table_az1.id
}
...
resource "aws_route_table_association" "private_subnet_az2_rt_az2_association" {
  subnet_id      = var.private_app_subnet_az2_id
  route_table_id = var.private_route_table_az2.id
}